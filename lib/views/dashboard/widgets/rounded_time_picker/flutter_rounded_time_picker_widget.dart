...
class _TimePickerHeader extends StatelessWidget {
  ...
  TextStyle _getBaseHeaderStyle(TextTheme headerTextTheme) {
    ...
    switch (orientation) {
      case Orientation.portrait:
        return headerTextTheme.bodyText2.copyWith(fontSize: 60.0);
      case Orientation.landscape:
        return headerTextTheme.bodyText1.copyWith(fontSize: 50.0);
    }
    return null;
  }
    ...
    if (mounted)
      setState(() {
        ...
        _thetaTween
          ..begin = angle
          ..end =
              angle; // The controller doesn't animate during the pan gesture.
...
class _TimePickerDialogState extends State<_TimePickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget actions = FlutterRoundedButtonAction(
      FlatButtonNegative: widget.negativeBtn,
      onTapButtonNegative: _handleCancel,
      FlatButtonPositive: widget.positiveBtn,
