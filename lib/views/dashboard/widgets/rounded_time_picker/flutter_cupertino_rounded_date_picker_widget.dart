...
class _DatePickerLayoutDelegate extends MultiChildLayoutDelegate {
  ...
  void performLayout(Size size) {
    ...
    for (int i = 0; i < columnWidths.length; i++) {
      ...
      positionChild(index, Offset(currentHorizontalOffset, _paddingTop));
...
class FlutterRoundedCupertinoDatePickerWidget extends StatefulWidget {
  ...
  static double _getColumnWidth(
    ...
    CupertinoLocalizations localizations = DefaultCupertinoLocalizations();
    String longestText = '';
...
class _CupertinoDatePickerDateTimeState
  ...
  void didChangeDependencies() {
    ...
    localizations =
        DefaultCupertinoLocalizations(); //CupertinoLocalizations.of(context);
