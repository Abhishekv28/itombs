...
class FlutterRoundedButtonAction extends StatelessWidget {
  final String FlatButtonNegative;
  final String FlatButtonPositive;
  ...
  const FlutterRoundedButtonAction(
      {Key key,
      this.localizations,
      this.FlatButtonNegative,
      this.FlatButtonPositive,
  ...
  List<Widget> _buildActionsButton(bool isActionButton) {
    ...
    final Widget negativeButton = FlatButton(
      child: Text(
        FlatButtonNegative ?? localizations.cancelButtonLabel,
    ...
    final Widget positiveButton = FlatButton(
      child: Text(
        FlatButtonPositive ?? localizations.okButtonLabel,
